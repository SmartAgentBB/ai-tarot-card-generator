...
export const ImageUploader: React.FC<ImageUploaderProps> = ({ onImageUpload }) => {
  ...
  const inactiveClasses = "border-slate-700 bg-black/20 hover:bg-black/40 hover:border-amber-400/50";
  const activeClasses = "border-amber-400 bg-amber-900/20";
    ...
    <div className="flex items-center justify-center w-full">
      ...
      >
        <div className="flex flex-col items-center justify-center pt-5 pb-6">
          ...
          <p className="mb-2 text-sm text-slate-400 font-sans">
            <span className="font-semibold text-amber-300">Click to upload</span> or drag and drop
          </p>
          <p className="text-xs text-slate-500 font-sans">PNG, JPG, or WEBP (MAX. 5MB)</p>
        </div>
